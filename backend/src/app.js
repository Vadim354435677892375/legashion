...
import { siteMediaRouter } from './routes/siteMedia.js';
...
import { adminSiteMediaRouter } from './routes/admin/siteMedia.js';
...
app.use('/api/admin/site-media', requireAdmin, adminSiteMediaRouter);
